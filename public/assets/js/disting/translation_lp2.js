const translations = {
    ...
    ku: {
        ...
        infoPin: 'ژمارەی مۆبایلەکەت داخڵ بکە بۆ وەرگرتنی PIN کۆد',
        confirmBtn: 'پشتڕاستکردنەوەی بەشداریکردن',
        continueText: 'بەدواداچوون',
        footerText: 'مرحبًا بك في مسابقة "المتميزون"',
        trialText: 'بۆ بەشداربووانی نوێ 3 ڕۆژی سەرەتا بەشداریکردن بێبەرامبەرە   پاشان نرخی بەشداریکردن 300 دینارە لە ڕۆژێکدا.',
