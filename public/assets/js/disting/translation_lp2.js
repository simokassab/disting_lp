const translations = {
    ar: {
        ...
        welcomeInfo: `أثبت ذكائك، اكسب لقب "المتميزون"،`,
        welcomeDesc: `كلما جمعت نقاطًا أكثر، زادت احتمالية وصولك إلى القمة`,
        subscribe: "إشترك",
        infoPhone: 'أدخل رقم جوالك لتتلقى رمز المرور',
        infoPin: 'رجاء إدخال رمز المرور الذي تلقيته',
        confirmBtn: 'تأكيد الاشتراك',
        continueText: 'متابعة',
        footerText: '• "مرحبًا بك في المتميزون',
    ...
    ku: {
        direction: 'rtl',
        languageBtn: 'كوردی',
        welcomeText: `بەخێربێیت بۆ "نایابەکان"`,
        welcomeInfo: `زیرەکی خۆت بسەلمێنە، نازناوی "ناوازە" بەدەست بهێنە.`,
        welcomeDesc: `تا خاڵی زیاتر کۆبکەیتەوە، ئەگەری گەیشتن بە لوتکە زیاتر دەبێت.`,
        subscribe: "بەشداربە",
        ...
        footerText: 'بەخێربێیت بۆ "نایابەکان"',
    ...
    en: {
        ...
        welcomeInfo: `Prove Your Intelligence, Earn the Title of The Distinguished`,
        welcomeDesc: 'The more points you have, the more possible it is for you to reach the top.',
        subscribe: "Subscribe",
        infoPhone: "Enter your mobile to receive a PIN code",
        infoPin: "Enter PIN code",
        continueText: 'Continue',
        confirmBtn: "Confirm Subscription",
        footerText: '• Welcome to "The Distinguished"! ',
